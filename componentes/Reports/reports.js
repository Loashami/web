function initComponent() {
  // Validar que hay botones de pestañas
  ...
  // Helper para inicializar un gráfico si el canvas existe
  const tryInitChart = (id, config) => {
  ...
  tryInitChart('appointmentsChart', {
    type: 'bar',
    data: {
  ...
  document.querySelectorAll('button').forEach(btn => {
    ...
    if (btn.textContent === 'Export') {
      btn.onclick = () => alert('Export feature coming soon!');
    }
  });
}
