// payments.js — corregido para evitar errores si el DOM no está listo

function initComponent() {
  if (!document.getElementById("payments-table")) return; // 🚫 Evita errores si el DOM aún no cargó
  ...
  function renderTable() {
    ...
    if (date) {
      ...
      document.getElementById("summary-date").textContent = `${monthName} ${year}`;
    } else {
