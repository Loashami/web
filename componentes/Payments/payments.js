 ...
 document.addEventListener("DOMContentLoaded", () => {
  const payments = [
    { id: "1", date: "2025-05-18", client: "Juan Pérez", amount: 85, service: "Vacunación", method: "credit_card", status: "completed", reference: "PAY-1234567890" },
    { id: "2", date: "2025-05-17", client: "Ana Torres", amount: 120, service: "Limpieza dental", method: "paypal", status: "completed", reference: "PAY-0987654321" },
    { id: "3", date: "2025-05-16", client: "Carlos Gómez", amount: 50, service: "Chequeo general", method: "cash", status: "completed", reference: "PAY-5678901234" },
    { id: "4", date: "2025-05-15", client: "Laura Díaz", amount: 35, service: "Vacunación", method: "credit_card", status: "completed", reference: "PAY-3456789012" },
    { id: "5", date: "2025-05-14", client: "David Romero", amount: 70, service: "Peluquería", method: "credit_card", status: "pending", reference: "PAY-9012345678" },
    { id: "6", date: "2025-05-13", client: "Camila Flores", amount: 200, service: "Esterilización", method: "credit_card", status: "pending", reference: "PAY-6789012345" },
  ];
  ...
  const getStatusClass = (status) => {
    switch (status) {
      ...
      case "refunded": return "bg-red-100 text-red-700 border border-red-300";
  ...
  function renderTable() {
    ...
    document.getElementById("summary-date").textContent = date
      ? new Date(date + "- 01").toLocaleString("es-ES", { month: "long", year: "numeric" })
      : "Este mes";
  ...
  function showDetails(id) {
    ...
    document.getElementById("modal-amount").textContent = `S/ ${pago.amount.toFixed(2)}`;
    document.getElementById("modal-method").textContent = getMethodLabel(pago.method);
    ...
    document.getElementById("modal-date").textContent = new Date(pago.date).toLocaleDateString("es-ES");
